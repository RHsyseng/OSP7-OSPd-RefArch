...
.Network topology
image::images/NETWORK.png[caption="Figure 3.1 ", title="Network
Topology", align="center", scaledwidth="80%"]
...
[[segregated-cluster]]
.Segregated cluster
image::images/HA_SEGREGATED.png[caption="Figure 3.2: ",
title="Segregated Cluster Services", align="center", scaledwidth="80%"]
...
[[collapsed-cluster]]
.Collapsed cluster
image::images/HA_COLLAPSED.png[caption="Figure 3.3: ",
title="Collapsed Cluter Services", align="center", scaledwidth="80%"]
...
[[ceph-integration]]
.Ceph Integration
image::images/CEPH.png[caption="Figure 3.4: ", title="Ceph
Integration", align="center", scaledwidth="80%"]
