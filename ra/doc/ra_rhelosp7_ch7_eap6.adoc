...
image::images/EAP6_MSA.png[caption="Figure 7.1: ", title="EAP6
Microservices Architecture", align="center", scaledwidth="50%"]
...
[[EAP6-web]]
.EAP6 Web Interface
image::images/EAP6_WEB.png[caption="Figure 7.2: ", title="EAP6 Web
Interface", align="center", scaledwidth="80%"]
