...
Heat Orchestration Templates are...
These are examples of nested HOTs...
Main HOT calls one for each microservice and one for the public
network


== Deploy instances
Create the MSA by calling the heat stack-create command
