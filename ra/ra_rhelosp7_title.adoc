...
//Deploying Red Hat JBOSS Enterprise Application Platform 6
//Microservices on High Availability Red Hat Enterprise Linux
//OpenStack Platform 7: with Red Hat Enterprise Linux OpenStack Platform director
